  ...
  return (
    <Fragment>
      ...
      >
        ...
        <hr className="border-b border-gray-200" />
        <div
          onClick={(e) => history.push("/admin/dashboard/product-approvals")}
          className={`${
            location.pathname === "/admin/dashboard/product-approvals"
              ? "border-r-4 border-gray-800 bg-gray-100"
              : ""
          } hover:bg-gray-200 cursor-pointer flex flex-col items-center justify-center py-6`}
        >
          ...
          <span className="hover:text-gray-800">Product Approvals</span>
        </div>
        <hr className="border-b border-gray-200" />
        <div
          ...
          <span>
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M5.121 17.804A13.937 13.937 0 0112 15c2.5 0 4.847.75 6.879 2.034M15 11a3 3 0 11-6 0 3 3 0 016 0zM19.071 4.929a10 10 0 11-14.142 0 10 10 0 0114.142 0z"
              />
            </svg>
          </span>
          <span className="hover:text-gray-800">User Data</span>
        </div>
        <hr className="border-b border-gray-200" />
      </div>
    </Fragment>
