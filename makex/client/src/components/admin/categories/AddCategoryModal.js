...
const AddCategoryModal = (props) => {
  ...
  const [fData, setFdata] = useState({
    ...
    cImage: "",
    cStatus: "Active",
    parentCategory: "",  // Added for subcategory parent selection
    success: false,
    error: false,
  });
  ...
  const fetchData = async () => {
    ...
    if (responseData.Categories) {
      ...
      // Set categories for parent category dropdown
      setParentCategories(responseData.Categories.filter(cat => !cat.parentCategory));
    }
  };
