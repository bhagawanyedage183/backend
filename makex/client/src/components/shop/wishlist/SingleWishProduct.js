            ...
            return (
              <div
                ...
                style={{
                  ...
                  transform: isRemoving ? "translateX(100%) scale(0.8)" : "none",
                  height: isRemoving ? 0 : "auto",
                  overflow: "hidden",
                  marginBottom: isRemoving ? 0 : "0.5rem",
                }}
                className="relative md:py-6 md:border-t md:border-b md:my-2 md:mx-0 col-span-1 md:flex md:items-center md:justify-between"
              >
                ...
                <div className="md:w-1/2 md:flex md:items-center md:justify-around">
                  ...
                  <div
                    ...
                    onClick={() => history.push(`/products/${product._id}`)}
                    className="inline-block px-4 py-2 text-white text-xs md:text-base text-center cursor-pointer hover:opacity-75 transition-transform transform hover:scale-105"
                  >
                    View
                  </div>
                </div>
